...
Everything past this point is the engineering. If you want to build one, follow sections 5, 6 and 7. If you want to understand how it works, section 8 covers the architecture.
